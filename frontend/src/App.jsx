    ...
    <div style={{ background: C.offWhite, fontFamily: F.body, overflowX: "hidden" }}>
      ...
      <header style={{
        ...
        <nav style={{ display: "flex", alignItems: "center", gap: 4 }}>
          ...
          <button onClick={() => goToDashboard("resolutions")} style={{
...
>
  ...
  >
    ...
    >
      ...
      >
        <button
          onClick={() => goToDashboard("resolutions")}
          style={{
            fontFamily: F.body,
            fontSize: 15,
            fontWeight: 700,
      ...
      <section id="features-section" style={{ padding: "72px 32px", maxWidth: 1180, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          {FEATURES.map((f, i) => (
            <FeatureCard key={f.id} feature={f} index={i} onNavigate={goToDashboard} />
          ))}
        </div>
      </section>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontFamily: F.heading, fontSize: 16, fontWeight: 700, color: C.white, marginBottom: 8 }}>{s.title}</div>
      ...
      <section style={{ padding: "80px 32px", textAlign: "center", background: C.unBlueLt, borderTop: `2px solid #b8dff5` }}>
        <div style={{ maxWidth: 620, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: F.body, fontSize: 15, color: C.textMid, marginBottom: 32, lineHeight: 1.7 }}>
            19 years of voting data. 193 countries. One dashboard.
          </p>
          <button
            onClick={() => goToDashboard("resolutions")}
            style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 32, marginBottom: 32 }}>
            ...
            <div>
              ...
              {["UN Digital Library", "UNGA Sessions", "Resolution Archive", "Voting Records"].map(d => (
